...
public abstract class MinesSweeperBoard extends JPanel implements Runnable
{
    ...
    public void paint(Graphics g2d)
    {
        ...
        if(game != null)
        {
            ...
            if(game.getState()==MinesSweeperGameState.GameOver)
                g.drawString("HAS PERDUT!",getWidth()/2-g.getFontMetrics().stringWidth("HAS PERDUT!")/2,40);
            if(game.getState()==MinesSweeperGameState.GameWin)
                g.drawString("MEGA WIN!",getWidth()/2-g.getFontMetrics().stringWidth("MEGA WIN!")/2,40);
